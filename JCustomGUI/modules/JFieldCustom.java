...
public class JFieldCustom {
  ...
  public static JTextField JITextCustom(int x, int y, int width, int height, int size, int radius) {
  ...
  public static JPasswordField JIPassCustom(int x, int y, int width, int height, int size, int radius) {
